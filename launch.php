...
<body>
    ...
    <div class="register">
        <div id="logsign">
            <div id="newuser">
                <h3>New user</h3>
            <form action="https://quora-for-engineeing-students.000webhostapp.com/signup.php">
                <button type="submit" class="btn btn-light btn-lg">Sign up</button> 
            </form>
            </div>
            <div id="existinguser">
                <h3>Existing user</h3>
            <form action="https://quora-for-engineeing-students.000webhostapp.com/login.php">
